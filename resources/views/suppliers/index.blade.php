                ...
                <div class="card">
                  ...
                  <div class="card-body col-lg-12">
                      ...
                      <div class="nav-tabs-wrapper">
                        <ul id="usertabs" class="nav nav-tabs" role="tablist">
                          <li class="nav-item linkpaging">
                            <a class="nav-link" href="{{ route('products.index') }}" role="tab" data-pagination-number="10" data-istable='true'><span class="now-ui-icons design_shape-circle" style=""></span> {{__('messages.productstab_products')}}</a>
                          </li>
                          <li class="nav-item linkpaging">
                            <a class="nav-link active" href="{{ route('suppliers.index') }}" ><span class="now-ui-icons design_shape-circle" style=""></span> {{__('messages.productstab_suppliers')}}</a>
                          </li>
                          <li class="nav-item linkpaging">
                    ...
                    <div id="" class="tab-content text-center">
                      ...
                      <div class="tab-pane active" id="suppls" role="tabpanel">
                        ...
                        <div class="row col-lg-12 mt-3">
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
                            ...
                            <div class="input-group no-border">
                              ...
                              <input type="text" value="" class="form-control"  id="search_input_" onkeyup="searchTable()" placeholder=" {{__('messages.supplier_inputsearch')}}">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 mt-0">
                            ...
                            <button type="button"  onclick="getForm('suppliers', null);" class="btn form-control" title=" {{__('messages.btn_addtips')}}" style="background: #f96332; color: #fff; font-size: 14px;"><span class="now-ui-icons ui-1_circle-add"></span> {{__('messages.btn_add')}}</button>
                        ...
                        <div class=" col-lg-12">
                          ...
                          <table class="table table-striped">
                            ...
                            <thead>
                              <tr>
                                <th> {{__('messages.sellscotationtable_id')}}</td>
                                <th> {{__('messages._fullname')}}</th>
                                <th>Email</th>
                                <th> {{__('messages._telephone')}}</th>
                                <th> {{__('messages._nuit')}}</th>
                                <th></th>
                              </tr>
                            </thead>
                            ...
                            @foreach($suppliers as $supplier)
                              <tr>
                                ...
                                <td align="right">
                                  ...
                                  @csrf
                                  @method('DELETE')
                                  <button  data-toggle="tooltip" data-placement="left" title=" {{__('messages.supplierstable_deletetips')}}" class="btn btn-round btn-xs mr-1" onclick="confirmRemotion('suppliers', {{$supplier->id}})" style="border-color:red; color:red;"><span class="now-ui-icons ui-1_trash"></span> </button>
                                  <button  data-toggle="tooltip" data-placement="left" title=" {{__('messages.supplierstable_edittips')}}" class="btn btn-round btn-xs mr-1" onclick="getForm('suppliers', {{$supplier->id}})"><span class="now-ui-icons ui-1_edit-74"></span> </button>
                                </td>
                              </tr>
                            @endforeach
                            </tbody>
