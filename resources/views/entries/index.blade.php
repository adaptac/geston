            ...
            <div class="row col-lg-12 mt-3">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
                ...
                <div class="input-group no-border">
                  ...
                  <input type="text" value="" class="form-control"  id="search_input_" onkeyup="searchTable()" placeholder="{{__('messages.entries_inputsearch')}}">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    ...
                    <button type="button"  onclick="getForm('entries', null);" class="btn form-control" title=" {{__('messages.btn_addtips')}}" style="background: #f96332; color: #fff; font-size: 14px;"><span class="now-ui-icons ui-1_circle-add"></span> {{__('messages.btn_add')}}</button>
              ...
              <div class=" col-lg-12">
                ...
                <table class="table table-striped">
                  ...
                  <thead>
                    <tr>
                      <th> {{__('messages._date')}}</td>
                      <th> {{__('messages._operatedby')}}</th>
                      <th> {{__('messages.productstab_suppliers')}}</th>
                      <th> {{__('messages._supplierscontacts')}}</th>
                      <th> {{__('messages.productstab_products')}}</th>
                      <th> {{__('messages._quantity')}}</th>
                      <th> {{__('messages._buyprice')}}</th>
                  ...
                  @if(count($entries))
                    ...
                    @foreach($entries as $entry)
                      <tr>
                        ...
                        <td>{{$entry->suppliercontact}}</td>
                        <td>{{$entry->product}}</td>
                        <td>{{$entry->quantity}}</td>
                        <td>{{number_format($entry->price,2,'.', ',')}}</td>
                        <td>{{number_format($entry->price*$entry->quantity,2,'.', ',')}}</td>
                      </tr>
                    @endforeach
