    ...
    <div class="container-fluid">
      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="content">
            ...
            <div id="cotation" class="tabbody container m-0 p-0 card"  data-pagination-number="4" data-istable="false"><!--Seccao para visualizacao de resusltado de pesquisa no sistema-->
            <div class="row col-lg-12 mt-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
                      ...
                      <div class="input-group no-border">
                        ...
                        <input type="text" value="" class="form-control"  id="search_input_" onkeyup="searchTable()" placeholder=" {{__('messages.clients_inputsearch')}}">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    ...
                    <button type="button"  onclick="getForm('clients', null);" class="btn form-control" title=" {{__('messages.btn_addtips')}}" style="background: #f96332; color: #fff; font-size: 14px;"><span class="now-ui-icons ui-1_circle-add"></span> {{__('messages.btn_add')}}</button>
                ...
                <table class="table table-striped">
                  ...
                  @if($cliente->id != 4)
                    <tr>
                      ...
                      <td>{{$cliente->nuitORbi}}</td>
                      <td align="right">

                        <button  data-toggle="tooltip" data-placement="left" title=" {{__('messages.clientstable_deletetips')}}" class="btn btn-round btn-xs mr-1" onclick="confirmRemotion('clients', {{$cliente->id}})" style="border-color:red; color:red;"><span class="now-ui-icons ui-1_trash"></span> </button>
                        <button  data-toggle="tooltip" data-placement="left" title=" {{__('messages.clientstable_edittips')}}" class="btn btn-round btn-xs mr-1" onclick="getForm('clients', {{$cliente->id}})"><span class="now-ui-icons ui-1_edit-74"></span> </button>
                      </td>
                    </tr>
                  @endif
                  @endforeach
